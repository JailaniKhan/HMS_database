              ...
              <div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Update role details and permissions</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {recentlySuccessful && (
              <div className="flex items-center gap-3 bg-green-50 border border-green-200 rounded-lg p-3">
                ...
                <div className="text-sm">
                  <span className="font-medium text-green-800">Role updated successfully!</span>
                </div>
              </div>
            )}
          </div>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-600">{role.users_count} assigned users</span>
                </div>
                <div className="flex items-center gap-2">
                  <Lock className="h-4 w-4 text-gray-500" />
                  <span className="text-sm text-gray-600">{role.permissions_count} permissions</span>
                </div>
                {role.module_access && role.module_access.length > 0 && (
                  <div className="flex items-center gap-2">
                    <span className="text-sm text-gray-600">Modules:</span>
                    <div className="flex gap-1">
                      {role.module_access.slice(0, 3).map((module, index) => (
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className={cn(
                          ...
                          role.is_system && "bg-gray-50 cursor-not-allowed",
                      ...
                      <div className="grid grid-cols-5 gap-2">
                        {[10, 30, 50, 70, 90].map((priority) => (
                          <Button
                            ...
                            className={cn(
                              "border-gray-300",
                              role.is_system && "bg-gray-100 cursor-not-allowed opacity-50",
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        setData('priority', role.priority);
                      }}
